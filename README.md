...
- **Mid-year / future-dated goals** — give a goal a start date so it stays out of your way (and out of your streak math) until it's actually time to focus on it
...
```bash
git clone https://github.com/sainikhilchidipothu/What-TO-DO.git
cd What-TO-DO
npm install
npm run dev
```
