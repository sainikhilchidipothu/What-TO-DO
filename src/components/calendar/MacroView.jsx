  ...
  return (
    <div className="macro-grid grid grid-cols-[repeat(2,minmax(0,1fr))] gap-5 max-w-[1600px] mx-auto">
      {Array.from({ length: 12 }, (_, m) => {
        ...
        const pColor = mpct >= 80 ? '#79a887' : mpct >= 50 ? '#c0a35e' : '#c27676'
              ...
              {Array.from({ length: dim }, (_, i) => {
                ...
                if (isVac) {
                  return (
                    <div
                      ...
                      className="calendar-day-cell w-full rounded flex flex-col items-center justify-between px-1 py-1 bg-zinc-950 border border-zinc-600 opacity-50 relative cursor-pointer"
                    >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="calendar-day-footer flex min-h-[10px] w-full justify-center items-center gap-0.5">
